          ...
          <div className="order-2 lg:order-1 animate-fade-up">
            ...
            <div className="flex items-center gap-3 mb-8 flex-wrap">
              <a 
                ...
                className="w-12 h-12 rounded-full bg-secondary flex items-center justify-center hover:bg-accent hover:text-accent-foreground hover:rotate-90 transition-all duration-500 btn-3d"
                aria-label="LinkedIn"
              >
                <Linkedin size={20} />
              </a>
