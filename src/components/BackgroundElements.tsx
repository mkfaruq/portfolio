...
const BackgroundElements = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-visible -z-10">
      ...
      <svg
        className="absolute top-[5%] left-[3%] w-16 h-16 sm:w-24 sm:h-24 md:w-32 md:h-32 opacity-[0.02] dark:opacity-[0.02] animate-float-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute top-[8%] right-[6%] w-16 h-16 sm:w-24 sm:h-24 md:w-36 md:h-36 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute top-[32%] left-[2%] w-14 h-14 sm:w-20 sm:h-20 md:w-28 md:h-28 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute top-[3%] left-[38%] w-12 h-12 sm:w-18 sm:h-18 md:w-24 md:h-24 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute top-[42%] right-[4%] w-20 h-20 sm:w-28 sm:h-28 md:w-40 md:h-40 opacity-[0.02] dark:opacity-[0.02] animate-pulse-slow"
        viewBox="0 0 100 100"
        fill="none"
        style={{ transform: `translateY(${scrollY * 0.08}px)` }}
      >
        <rect x="5" y="5" width="90" height="90" className="stroke-foreground/50" strokeWidth="2" />
        <rect x="15" y="15" width="70" height="70" className="stroke-primary/60" strokeWidth="2" />
        <rect x="25" y="25" width="50" height="50" className="stroke-accent/60" strokeWidth="2" />
        <rect x="35" y="35" width="30" height="30" className="stroke-secondary/60" strokeWidth="2" />
        <circle cx="50" cy="50" r="8" className="fill-accent/60" />
      </svg>

      {/* Hexagon - bottom left - with rotation */}
      <svg
        className="absolute bottom-[18%] left-[5%] w-16 h-16 sm:w-24 sm:h-24 md:w-32 md:h-32 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute bottom-[8%] right-[3%] w-20 h-20 sm:w-32 sm:h-32 md:w-44 md:h-44 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute top-[22%] right-[28%] w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 opacity-[0.02] dark:opacity-[0.02] animate-float"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute top-[58%] left-[22%] w-10 h-10 sm:w-14 sm:h-14 md:w-20 md:h-20 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute top-[72%] right-[20%] w-10 h-10 sm:w-14 sm:h-14 md:w-18 md:h-18 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute bottom-[5%] left-[42%] w-16 h-16 sm:w-24 sm:h-24 md:w-32 md:h-32 opacity-[0.02] dark:opacity-[0.02] animate-float"
        viewBox="0 0 100 100"
        fill="none"
        style={{ transform: `translateY(${scrollY * -0.08}px)` }}
      >
      ...
      <svg
        className="absolute top-[28%] left-[18%] w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute top-[52%] left-[48%] w-8 h-8 sm:w-10 sm:h-10 md:w-14 md:h-14 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
        style={{ animationDuration: '50s' }}
      >
      ...
      {/* Hexagon - upper right */}
      <svg
        className="absolute top-[15%] left-[58%] w-10 h-10 sm:w-14 sm:h-14 md:w-18 md:h-18 opacity-[0.02] dark:opacity-[0.02] animate-float-reverse"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute top-[68%] left-[8%] w-6 h-6 sm:w-8 sm:h-8 md:w-12 md:h-12 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute top-[12%] right-[35%] w-5 h-5 sm:w-7 sm:h-7 md:w-10 md:h-10 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      <svg
        className="absolute bottom-[32%] right-[12%] w-8 h-8 sm:w-10 sm:h-10 md:w-14 md:h-14 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
        style={{ animationDuration: '40s', animationDirection: 'reverse' }}
      >
      ...
      <svg
        className="absolute top-[38%] left-[32%] w-6 h-6 sm:w-8 sm:h-8 md:w-12 md:h-12 opacity-[0.02] dark:opacity-[0.02] animate-spin-slow"
        viewBox="0 0 100 100"
        fill="none"
      ...
      {/* Glowing orbs */}
      <div 
        className="absolute top-[18%] right-[42%] w-3 h-3 sm:w-4 sm:h-4 md:w-6 md:h-6 rounded-full bg-primary/20 opacity-[0.02] dark:opacity-[0.02] blur-md animate-pulse-slow"
        style={{ transform: `translateY(${scrollY * 0.1}px)` }}
      />
      <div 
        className="absolute bottom-[28%] left-[38%] w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 md:w-5 md:h-5 rounded-full bg-secondary/20 opacity-[0.02] dark:opacity-[0.02] blur-md animate-float"
        style={{ animationDelay: '2s', transform: `translateY(${scrollY * -0.12}px)` }}
      />
      <div 
        className="absolute top-[48%] left-[55%] w-2 h-2 sm:w-3 sm:h-3 md:w-4 md:h-4 rounded-full bg-accent/20 opacity-[0.02] dark:opacity-[0.02] blur-md animate-float-reverse"
        style={{ transform: `translateY(${scrollY * 0.08}px)` }}
      />
      <div 
        className="absolute top-[75%] right-[38%] w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 md:w-5 md:h-5 rounded-full bg-foreground/20 opacity-[0.02] dark:opacity-[0.02] blur-md animate-pulse-slow"
